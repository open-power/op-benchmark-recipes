...
runspec -c LE64Test_P9 --define p9_${corenum}_core=1 --define install_path=$(pwd) --tune base --rate --size=ref int
runspec -c LE64Test_P9 --define p9_${corenum}_core=1 --define install_path=$(pwd) --tune peak --rate --size=ref int
